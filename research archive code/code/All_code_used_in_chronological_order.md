This file contains all the code, in chronological order, to reproduce my Thesis. Due to privacy reasons and the rules of Statistics Netherlands, no raw input data is available. However, the folder structure and names of the files that are needed are present. \#\#\# Packages and working directory
...
This code can be used to scrape context location data from OpenStreetMaps
